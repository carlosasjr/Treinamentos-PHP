...
include_once './APP.ADO/TCriterio.class.php';
include_once './APP.ADO/TFilter.class.php';


//aqui vemos um exemplo de critério utizando o operador lógico OR
//a idade deve ser menor que 16 ou maior que 60
$criteria = new TCriterio();
...
//juntamente com os operadores de conjunto IN (dentro do conjunto) e NO IN (for do conjunto)
...
//aqui vemos um exemplo de critério utilizando o operador de compração LIKE
...
//aqui vemos o uso dos operadores de compração IN e NOT IN juntamento com
...
//o pirmeito critério aponta para sexo='F'
//(sexo feminino) e idade > 18 (maior de idade)
$criteria1 = new TCriterio();
...
$criteria2 = new TCriterio();
$criteria2->add(new TFilter('sexo', '=', 'M'));
$criteria2->add(new TFilter('idade', '<', '16'));

//agora juntamos os dois critério utilizando o operador lógico OR(ou)
//O resultado deve conter mulhres maiores de 18 OU homens menores de 16
$criteria = new TCriterio();
...
$criteria1->add(new TFilter('sexo', '=', 'F'));
$criteria1->add(new TFilter('idade', '>', '18'));
$criteria1->add(new TFilter('sexo', '=', 'M'),TExpression::OR_OPERATOR);
